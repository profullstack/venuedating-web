...
-- Revert the insert_place_with_coordinates function to original version
-- CREATE OR REPLACE FUNCTION insert_place_with_coordinates(
--   p_title TEXT,
--   p_latitude DECIMAL,
--   p_longitude DECIMAL,
...
-- Drop the photos column and related objects
-- ALTER TABLE places DROP CONSTRAINT IF EXISTS places_photos_is_array;
-- DROP INDEX IF EXISTS idx_places_photos;
