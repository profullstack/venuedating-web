...
echo -e "${BLUE}=== Twilio Direct Integration Test Runner ===${NC}"
...
echo
echo -e "${YELLOW}This script will test the Twilio direct integration by:${NC}"
echo "1. Sending verification codes to test phone numbers"
echo "2. Verifying codes with test bypass code (123456)"
...
# Run the test script
echo -e "${GREEN}Running Twilio direct integration tests...${NC}"
echo
API_BASE_URL=http://localhost:3000 node tests/twilio-direct-test.js
