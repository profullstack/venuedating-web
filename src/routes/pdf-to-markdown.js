import { pdfToMarkdownService } from '../services/pdf-to-markdown-service.js';
import { storageService } from '../services/storage-service.js';
import { validateBody, validators } from '../middleware/error-handler.js';
import { errorUtils } from '../utils/error-utils.js';

/**
 * Route handler for converting PDF to Markdown
 * @param {Object} c - Hono context
 * @returns {Response} - Markdown content response
 */
export async function pdfToMarkdownHandler(c) {
  try {
    ...
    const markdownContent = await pdfToMarkdownService.convertToMarkdown(fileBuffer);
...
/**
 * Route configuration for PDF to Markdown endpoint
 */
export const pdfToMarkdownRoute = {
  method: 'POST',
  path: '/api/1/pdf-to-markdown',
  middleware: [validateBody(validators.pdfFileContent)],
