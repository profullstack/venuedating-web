  ...
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <nav class="bottom-nav">
        <a href="/discover" class="nav-item ${currentPage === 'discover' ? 'active' : ''}" title="Discover" aria-label="Discover" data-i18n-title="nav.discover" data-i18n-aria-label="nav.discover">
          <svg width="24" height="24" viewBox="0 0 24 24" stroke-width="2">
            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
          </svg>
        </a>
        <a href="/matching" class="nav-item ${currentPage === 'matching' ? 'active' : ''}" title="Matching" aria-label="Matching" data-i18n-title="nav.matching" data-i18n-aria-label="nav.matching">
          <svg width="24" height="24" viewBox="0 0 24 24" stroke-width="2">
        ...
        <a href="/chat" class="nav-item ${currentPage === 'chat' ? 'active' : ''}" title="Chat" aria-label="Chat" data-i18n-title="nav.chat" data-i18n-aria-label="nav.chat">
          <svg width="24" height="24" viewBox="0 0 24 24" stroke-width="2">
